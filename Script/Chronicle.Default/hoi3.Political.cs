...
{
    [Serializable]
    public class hoi3_Political : MultiDatakeyTable
    {
        public hoi3_Political() : base("Political", TableType.Province)
        {
            Caption = "Political";
            Category = "Political";
    ...
    [Serializable]
    public class hoi3_ProvincesCount : SingleValueTable
    {
        public hoi3_ProvincesCount() : base("ProvincesCount", TableType.Country)
        {
    ...
    [Serializable]
    public class hoi3_Cores : MultiDatakeyTable
    {
        public hoi3_Cores() : base("Cores", TableType.Province)
        {
