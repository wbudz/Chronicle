...
{
    [Serializable]
    public class hoi4_Terrain : MultiValueTable
    {
        public hoi4_Terrain() : base("Terrain", TableType.Province)
        {
            Caption = "Terrain";
            Category = "General";
            Section = 1;
    ...
    //[Serializable]
    //public class hoi4_ProvinceVP : SingleValueTable
    //{   
    //    public hoi4_ProvinceVP() : base("ProvinceVP", TableType.Province)
    //    {
    ...
    //[Serializable]
    //public class hoi4_CountryVP : SingleValueTable
    //{
    //    public hoi4_CountryVP() : base("CountryVP", TableType.Country)
    //    {
    ...
    //[Serializable]
    //public class hoi4_ProvinceFlags : MultiDatakeyTable
    //{
    //    public hoi4_ProvinceFlags() : base("ProvinceFlags", TableType.Province)
    //    {
    ...
    //[Serializable]
    //public class hoi4_CountryFlags : MultiDatakeyTable
    //{
    //    public hoi4_CountryFlags() : base("CountryFlags", TableType.Country)
    //    {
